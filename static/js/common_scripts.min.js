!(function (t, e) {
  ...
  function C(t, e) {
    ...
    if ((t !== l && e !== l) || s.contains(n))
      return "BODY" === (a = (r = l).nodeName) ||
        ("HTML" !== a && w(r.firstElementChild) !== r)
        ? w(l)
        : l;
    var h = c(t);
  ...
  function d(t, e, i, s) {
    ...
    if ("viewport" === s)
      ...
      var p;
      "scrollParent" === s
        ? "BODY" === (p = y(b(t))).nodeName &&
          (p = window.document.documentElement)
        : (p = "window" === s ? window.document.documentElement : s);
      var f = I(p, d);
      if (
        "HTML" !== p.nodeName ||
        (function t(e) {
  ...
  function P(t, i, e) {
    return (
      (void 0 === e
        ...
        t.enabled &&
          r(e) &&
          ((i.offsets.popper = k(i.offsets.popper)),
          (i.offsets.reference = k(i.offsets.reference)),
          (i = e(i, t)));
      }),
      i
    );
  ...
  for (
    var v = Math.min,
      M = Math.floor,
      N = Math.max,
      o = ["native code", "[object MutationObserverConstructor]"],
  ...
  var $,
    ...
    j = function () {
      return (
        null == $ && ($ = -1 !== navigator.appVersion.indexOf("MSIE 10")), $
      );
    },
    q = (function () {
      function s(t, e) {
    ...
    Z = (function () {
      function o(t, e) {
        ...
        (function (t, e) {
          ...
          Object.keys(Y({}, o.Defaults.modifiers, s.modifiers)).forEach(
            function (t) {
              i.options.modifiers[t] = Y(
                {},
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            var s = t.placement.split("-")[0],
              ...
              u = a ? "bottom" : "right",
              d = f(i)[l];
            r[u] - d < o[h] && (t.offsets.popper[h] -= o[h] - (r[u] - d)),
              r[h] + d > o[u] && (t.offsets.popper[h] += r[h] + d - o[u]);
            ...
            return (
              y.forEach(function (t, e) {
                ...
                var i,
                  ...
                  o = M,
                  r =
                    ("left" === v && o(s.right) > o(n.left)) ||
                    ("right" === v && o(s.left) < o(n.right)) ||
                    ("top" === v && o(s.bottom) > o(n.top)) ||
                    ("bottom" === v && o(s.top) < o(n.bottom)),
                  a = o(s.left) < o(m.left),
                ...
                (r || u || p) &&
                  ...
                  (f.offsets.popper = Y(
                    {},
                    f.offsets.popper,
                    T(f.instance.popper, f.offsets.reference, f.placement)
                  )),
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            var r,
              ...
              f = F("transform");
            if (
              ((a = "bottom" == d ? -h.height + u.bottom : u.top),
              (r = "right" == p ? -h.width + u.right : u.left),
              l && f)
            )
              (c[f] = "translate3d(" + r + "px, " + a + "px, 0)"),
                (c[d] = 0),
                (c[p] = 0),
    ...
    var n,
      ...
      ji =
          ...
          return (
            (t.toggle = function () {
              ...
              if (i) {
                ...
                if (s) {
                  if ("radio" === s.type)
                    if (s.checked && this._element.classList.contains(C))
                      t = !1;
                    else {
                  ...
                  if (t) {
                    if (
                      ...
                      return;
                    (s.checked = !this._element.classList.contains(C)),
                      m(s).trigger("change");
                  }
                  s.focus(), (e = !1);
                }
            ...
            (i._jQueryInterface = function (e) {
              return this.each(function () {
                var t = m(this).data(_);
                t || ((t = new i(this)), m(this).data(_, t)),
                  "toggle" === e && t[e]();
              });
            }),
            r(i, null, [
        ...
        m(document)
          .on(A.CLICK_DATA_API, k, function (t) {
            t.preventDefault();
            var e = t.target;
            m(e).hasClass(D) || (e = m(e).closest(T)),
              P._jQueryInterface.call(m(e), "toggle");
          })
          ...
          return (
            ...
            (t.pause = function (t) {
              t || (this._isPaused = !0),
                this._element.querySelector(et) &&
                  (Li.triggerTransitionEnd(this._element), this.cycle(!0)),
            ...
            (o._jQueryInterface = function (s) {
              return this.each(function () {
                ...
                if (
                  (t || ((t = new o(this, e)), F(this).data(N, t)),
                  "number" == typeof s)
                )
                  t.to(s);
        ...
        (Ct = (function () {
          function a(e, t) {
            (this._isTransitioning = !1),
              ...
              (this._triggerArray = rt.makeArray(
          ...
          return (
            ...
            (t.show = function () {
              ...
              if (
                ...
                !(
                  t &&
                  (e = rt(t).not(this._selector).data(lt)) &&
                  e._isTransitioning
                ))
              ) {
                ...
                if ((rt(this._element).trigger(s), !s.isDefaultPrevented())) {
                  t &&
                    (a._jQueryInterface.call(rt(t).not(this._selector), "hide"),
                    e || rt(t).data(lt, null));
                  var n = this._getDimension();
                  rt(this._element).removeClass(gt).addClass(mt),
                    (this._element.style[n] = 0),
                    this._triggerArray.length &&
                      rt(this._triggerArray)
                        .removeClass(vt)
                  ...
                  rt(this._element)
                    .one(Li.TRANSITION_END, function () {
                      rt(i._element).removeClass(mt).addClass(gt).addClass(ft),
                        (i._element.style[n] = ""),
                        i.setTransitioning(!1),
                        rt(i._element).trigger(pt.SHOWN);
                    })
                    ...
                    for (var n = 0; n < s; n++) {
                      ...
                      if (null !== r)
                        rt(
                          ...
                          rt(o).addClass(vt).attr("aria-expanded", !1);
                    }
                  this.setTransitioning(!0);
                  this._element.style[i] = "";
            ...
            (t.dispose = function () {
              rt.removeData(this._element, lt),
                (this._config = null),
                (this._parent = null),
                (this._element = null),
            ...
            (t._getParent = function () {
              var i = this,
                t = null;
              Li.isElement(this._config.parent)
      ...
      Yi =
        ...
        (Zt = (function () {
          ...
          return (
                  ...
                  if ((Dt(t).trigger(s), !s.isDefaultPrevented())) {
                    if (!this._inNavbar) {
                      ...
                      "parent" === this._config.reference
                        ? (n = t)
                        : Li.isElement(this._config.reference) &&
            ...
            (t.dispose = function () {
              Dt.removeData(this._element, kt),
                Dt(this._element).off(Et),
                (this._element = null),
            ...
            (t._getConfig = function (t) {
              return (
                (t = l(
                  ...
                  Dt(this._element).data(),
                  t
                )),
                Li.typeCheckConfig(xt, t, this.constructor.DefaultType),
                t
              );
            }),
            ...
            (t._getPlacement = function () {
              ...
              return (
                t.hasClass(Mt)
                  ? ((e = qt), Dt(this._menu).hasClass(zt) && (e = Bt))
                  : t.hasClass(Nt)
                  ? (e = Ut)
                  : t.hasClass(Ot)
                  ? (e = Qt)
                  : Dt(this._menu).hasClass(zt) && (e = Kt),
                e
              );
            }),
            ...
            (h._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  (t ||
                    ((t = new h(this, "object" == typeof e ? e : null)),
                    Dt(this).data(kt, t)),
                  "string" == typeof e)
                ) {
                  if (void 0 === t[e])
                  ...
                  ? !(
                      ...
                      (27 !== t.which &&
                        ((40 !== t.which && 38 !== t.which) ||
                          Dt(t.target).closest(Lt).length))
                    )
                  : Tt.test(t.which)) &&
                (t.preventDefault(),
                t.stopPropagation(),
                !this.disabled && !Dt(this).hasClass(Pt))
              ) {
        ...
        Dt(document)
          ...
          .on(At.CLICK_DATA_API, Wt, function (t) {
            t.preventDefault(),
              t.stopPropagation(),
              Zt._jQueryInterface.call(Dt(this), "toggle");
          })
          ...
          return (
            ...
            (t._enforceFocus = function () {
              ...
              Gt(document)
                ...
                .on(oe.FOCUSIN, function (t) {
                  document !== t.target &&
                    e._element !== t.target &&
                    0 === Gt(e._element).has(t.target).length &&
                    e._element.focus();
                });
            }),
            ...
            (t._hideModal = function () {
              ...
              (this._element.style.display = "none"),
                ...
                (this._isTransitioning = !1),
                this._showBackdrop(function () {
                  Gt(document.body).removeClass(le),
                    t._resetAdjustments(),
                    t._resetScrollbar(),
                    Gt(t._element).trigger(oe.HIDDEN);
                });
            }),
            ...
            (t._resetScrollbar = function () {
              ...
              Gt(e).each(function (t, e) {
                ...
                void 0 !== i &&
                  Gt(e).css("margin-right", i).removeData("margin-right");
              });
              var i = Gt(document.body).data("padding-right");
              Gt(document.body).removeData("padding-right"),
            ...
            (n._jQueryInterface = function (i, s) {
              return this.each(function () {
                ...
                if (
                  (t || ((t = new n(this, e)), Gt(this).data(te, t)),
                  "string" == typeof i)
                ) {
                  if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
      ...
      Ui =
        ...
        (We = (function () {
          ...
          return (
              ...
              if (this._isEnabled)
                if (t) {
                  ...
                  i ||
                    ...
                    ve(t.currentTarget).data(e, i)),
                    (i._activeTrigger.click = !i._activeTrigger.click),
                    i._isWithActiveTrigger()
                      ? i._enter(null, i)
                      : i._leave(null, i);
                } else {
                  if (ve(this.getTipElement()).hasClass(Pe))
            ...
            (t.show = function () {
              var e = this;
              if ("none" === ve(this.element).css("display"))
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                s.setAttribute("id", n),
                  ...
                  this.setContent(),
                  this.config.animation && ve(s).addClass(Ae);
                var o =
                ...
                var a =
                  !1 === this.config.container
                    ? document.body
                    : ve(document).find(this.config.container);
                ve(s).data(this.constructor.DATA_KEY, this),
                  ...
                  ve(s).addClass(Pe),
                  "ontouchstart" in document.documentElement &&
                    ve(document.body).children().on("mouseover", null, ve.noop);
                var l = function () {
                  e.config.animation && e._fixTransition();
                  var t = e._hoverState;
                  (e._hoverState = null),
                    ve(e.element).trigger(e.constructor.Event.SHOWN),
                    t === Se && e._leave(null, e);
                };
                if (ve(this.tip).hasClass(Ae)) {
                  var h = Li.getTransitionDurationFromElement(this.tip);
                  ve(this.tip)
                    .one(Li.TRANSITION_END, l)
            ...
            (t.setContent = function () {
              ...
              this.setElementContent(
                ve(t.querySelectorAll(Fe)),
                this.getTitle()
              ),
                ve(t).removeClass(Ae + " " + Pe);
            }),
            (t.setElementContent = function (t, e) {
              var i = this.config.html;
              "object" == typeof e && (e.nodeType || e.jquery)
                ? i
                  ? ve(e).parent().is(t) || t.empty().append(e)
                  : t.text(ve(e).text())
                : t[i ? "html" : "text"](e);
            }),
            (t.getTitle = function () {
            ...
            (t._setListeners = function () {
              ...
              this.config.trigger.split(" ").forEach(function (t) {
                if ("click" === t)
                  ...
                  var e =
                      t === Ne
                        ? s.constructor.Event.MOUSEENTER
                        : s.constructor.Event.FOCUSIN,
                    i =
                      t === Ne
                        ? s.constructor.Event.MOUSELEAVE
                        : s.constructor.Event.FOCUSOUT;
                  ve(s.element)
            ...
            (t._enter = function (t, e) {
              ...
              (e = e || ve(t.currentTarget).data(i)) ||
                ((e = new this.constructor(
                  t.currentTarget,
                  this._getDelegateConfig()
                )),
                ve(t.currentTarget).data(i, e)),
            ...
            (s._jQueryInterface = function (i) {
              return this.each(function () {
                ...
                if (
                  ...
                  (t || ((t = new s(this, e)), ve(this).data(be, t)),
                  "string" == typeof i)
                ) {
                  if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
            ...
            (s._jQueryInterface = function (i) {
              return this.each(function () {
                ...
                if (
                  ...
                  (t || ((t = new s(this, e)), $e(this).data(Re, t)),
                  "string" == typeof i)
                ) {
                  if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
      ...
      Vi =
        ...
        (wi = (function () {
          ...
          return (
            (t.refresh = function () {
              var e = this,
                t =
                  this._scrollElement === this._scrollElement.window ? bi : yi,
            ...
            (t._getConfig = function (t) {
              if (
                "string" !=
                typeof (t = l({}, oi, "object" == typeof t && t ? t : {}))
                  .target
              ) {
                var e = ti(t.target).attr("id");
                e || ((e = Li.getUID(ei)), ti(t.target).attr("id", e)),
                  (t.target = "#" + e);
              }
            ...
            (t._activate = function (e) {
              ...
              i.hasClass(li)
                ...
                ti(this._scrollElement).trigger(ai.ACTIVATE, {
                  relatedTarget: e,
                });
            }),
            (t._clear = function () {
        ...
        ti(window).on(ai.LOAD_DATA_API, function () {
          for (
            var t = [].slice.call(document.querySelectorAll(ci)), e = t.length;
            e--;
        ...
        ($i = (function () {
          ...
          return (
            (t.show = function () {
              ...
              if (
                !(
                  (this._element.parentNode &&
                    this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                    Ci(this._element).hasClass(Si)) ||
                  Ci(this._element).hasClass(Ti)
                )
              ) {
                var t,
                  s,
            ...
            (t._activate = function (t, e, i) {
              var s = this,
                n = (
                  "UL" === e.nodeName ? Ci(e).find(Oi) : Ci(e).children(Ni)
                )[0],
            ...
            (t._transitionComplete = function (t, e, i) {
              ...
              if (
                ...
                Li.reflow(t),
                Ci(t).addClass(Pi),
                t.parentNode && Ci(t.parentNode).hasClass(Ii))
              ) {
  ...
  (function (a, t) {
    ...
    function r(t) {
      return !a(t)
        ...
        .filter(function () {
          return (
            "hidden" === a.curCSS(this, "visibility") ||
        ...
        a("<a>").outerWidth(1).jquery ||
          a.each(["Width", "Height"], function (t, i) {
            function s(t, e, i, s) {
              return (
                a.each(n, function () {
                  (e -= parseFloat(a.curCSS(t, "padding" + this, !0)) || 0),
                    i &&
                      (e -=
                        parseFloat(
                          a.curCSS(t, "border" + this + "Width", !0)
                        ) || 0),
                    s &&
                      (e -= parseFloat(a.curCSS(t, "margin" + this, !0)) || 0);
                }),
                e
              );
            }
      ...
      (r.Widget.prototype = {
        ...
        _trigger: function (t, e, i) {
          ...
          return (
            ...
            !(
              (r.isFunction(o) && !1 === o.call(this.element[0], e, i)) ||
    ...
    b.widget("ui.draggable", b.ui.mouse, {
      ...
      _mouseCapture: function (t) {
        ...
        return (
          !(
            this.helper ||
            e.disabled ||
            b(t.target).is(".ui-resizable-handle")
          ) &&
      ...
      _mouseStop: function (t) {
        ...
        b.ui.ddmanager &&
          ...
          (e = b.ui.ddmanager.drop(this, t)),
          this.dropped && ((e = this.dropped), (this.dropped = !1));
        for (var i = this.element[0], s = !1; i && (i = i.parentNode); )
          i == document && (s = !0);
        ...
        if (
          ...
          ("document" != t.containment && "window" != t.containment) ||
            (this.containment = [
              ...
              ("document" == t.containment ? 0 : b(window).scrollLeft()) +
                b("document" == t.containment ? document : window).width() -
                this.helperProportions.width -
                this.margins.left,
              ("document" == t.containment ? 0 : b(window).scrollTop()) +
                (b("document" == t.containment ? document : window).height() ||
          ...
          (this.containment = [
            (parseInt(b(i).css("borderLeftWidth"), 10) || 0) +
              (parseInt(b(i).css("paddingLeft"), 10) || 0),
            (parseInt(b(i).css("borderTopWidth"), 10) || 0) +
              (parseInt(b(i).css("paddingTop"), 10) || 0),
      ...
      _generatePosition: function (t) {
        ...
        if (this.originalPosition) {
          ...
          if (e.grid) {
            var l = e.grid[1]
              ? this.originalPageY +
                Math.round((o - this.originalPageY) / e.grid[1]) * e.grid[1]
              : this.originalPageY;
            o =
              r &&
            ...
            var h = e.grid[0]
              ? this.originalPageX +
                Math.round((n - this.originalPageX) / e.grid[0]) * e.grid[0]
              : this.originalPageX;
            n =
              r &&
              (h - this.offset.click.left < r[0] ||
                h - this.offset.click.left > r[2])
                ? h - this.offset.click.left < r[0]
                  ? h + e.grid[0]
                  : h - e.grid[0]
                : h;
        ...
        drag: function (t, e) {
          ...
          i.scrollParent[0] != document && "HTML" != i.scrollParent[0].tagName
            ...
            : ((s.axis && "x" == s.axis) ||
                (t.pageY - b(document).scrollTop() < s.scrollSensitivity
                  ? (n = b(document).scrollTop(
                      b(document).scrollTop() - s.scrollSpeed
                    ))
              ...
              (s.axis && "y" == s.axis) ||
                (t.pageX - b(document).scrollLeft() < s.scrollSensitivity
                  ? (n = b(document).scrollLeft(
                      b(document).scrollLeft() - s.scrollSpeed
                    ))
            ...
            !1 !== n &&
              b.ui.ddmanager &&
              !s.dropBehaviour &&
              b.ui.ddmanager.prepareOffsets(i, t);
        },
      }),
        ...
        drag: function (t, e) {
          for (
            var i = b(this).data("draggable"),
              ...
              n = s.snapTolerance,
              o = e.offset.left,
              r = o + i.helperProportions.width,
              a = e.offset.top,
              l = a + i.helperProportions.height,
              h = i.snapElements.length - 1;
            0 <= h;
            h--
          ) {
            ...
            if (
              ...
              if ("inner" != s.snapMode) {
                ...
                f &&
                  ...
                  g &&
                    (e.position.top =
                      i._convertPositionTo("relative", { top: p, left: 0 })
                        .top - i.margins.top),
                  m &&
                    (e.position.left =
                      i._convertPositionTo("relative", {
                  ...
                  v &&
                    (e.position.left =
                      i._convertPositionTo("relative", { top: 0, left: u })
                        .left - i.margins.left);
              }
              var _ = f || g || m || v;
              if ("outer" != s.snapMode) {
                ...
                f &&
                  (e.position.top =
                    i._convertPositionTo("relative", { top: d, left: 0 }).top -
                    i.margins.top),
                  g &&
                    (e.position.top =
                      i._convertPositionTo("relative", {
                  ...
                  m &&
                    (e.position.left =
                      i._convertPositionTo("relative", { top: 0, left: c })
                        .left - i.margins.left),
                  v &&
                    (e.position.left =
                      i._convertPositionTo("relative", {
              ...
              !i.snapElements[h].snapping &&
                ...
                i.options.snap.snap.call(
                  i.element,
                  t,
                  b.extend(i._uiHash(), { snapItem: i.snapElements[h].item })
                ),
    ...
    p.widget("ui.droppable", {
      ...
      _create: function () {
        ...
        (this.isover = 0),
          ...
          (p.ui.ddmanager.droppables[t.scope] =
            p.ui.ddmanager.droppables[t.scope] || []),
      ...
      destroy: function () {
        for (
          var t = p.ui.ddmanager.droppables[this.options.scope], e = 0;
          e < t.length;
          e++
        )
          ...
          this.element
            ...
            .each(function () {
              ...
              if (
                ...
                p.ui.intersect(
                  i,
                  p.extend(t, { offset: t.element.offset() }),
                  t.options.tolerance
                )
              )
                return !(s = !0);
      ...
      (p.ui.intersect = function (t, e, i) {
        ...
        switch (i) {
          ...
          case "intersect":
            return (
              a < s + t.helperProportions.width / 2 &&
          ...
          case "touch":
            return (
              ((h <= o && o <= c) || (h <= r && r <= c) || (o < h && c < r)) &&
              ((a <= s && s <= l) || (a <= n && n <= l) || (s < a && l < n))
            );
          default:
            return !1;
        }
      ...
      (p.ui.ddmanager = {
          ...
          t: for (var o = 0; o < i.length; o++)
            if (
              ...
              (i[o].visible = "none" != i[o].element.css("display")),
                i[o].visible &&
                  ("mousedown" == s && i[o]._activate.call(i[o], e),
        ...
        drop: function (t, e) {
          ...
          return (
            p.each(
              p.ui.ddmanager.droppables[t.options.scope] || [],
              function () {
                this.options &&
                  (!this.options.disabled &&
                    this.visible &&
                    p.ui.intersect(t, this, this.options.tolerance) &&
        ...
        drag: function (n, o) {
          n.options.refreshPositions && p.ui.ddmanager.prepareOffsets(n, o),
            p.each(
              p.ui.ddmanager.droppables[n.options.scope] || [],
              function () {
                if (
                  !this.options.disabled &&
                  !this.greedyChild &&
                  ...
                  if (e) {
                    ...
                    if (this.options.greedy) {
                      ...
                      s.length &&
                        ((i = p.data(s[0], "droppable")).greedyChild =
                          "isover" == e ? 1 : 0);
                    }
                    i &&
                      "isover" == e &&
                      ((i.isover = 0), (i.isout = 1), i._out.call(i, o)),
                      (this[e] = 1),
                      (this["isout" == e ? "isover" : "isout"] = 0),
                      this["isover" == e ? "_over" : "_out"].call(this, o),
                      i &&
                        "isout" == e &&
                        ((i.isout = 0), (i.isover = 1), i._over.call(i, o));
                  }
                }
              }
            );
    ...
    f.widget("ui.resizable", f.ui.mouse, {
          ...
          for (var e in ((t = t || this.element), this.handles)) {
            if (
              (this.handles[e].constructor == String &&
                (this.handles[e] = f(this.handles[e], this.element).show()),
      ...
      _mouseCapture: function (t) {
        ...
        for (var i in this.handles)
          f(this.handles[i])[0] == t.target && (e = !0);
      ...
      _mouseStart: function (t) {
        ...
        e.containment &&
          ((n += f(e.containment).scrollLeft() || 0),
          (o += f(e.containment).scrollTop() || 0)),
        ...
        return (
          f("body").css("cursor", "auto" == r ? this.axis + "-resize" : r),
      ...
      _mouseStop: function (t) {
        ...
        if (this._helper) {
          ...
          e.animate || this.element.css(f.extend(a, { top: h, left: l })),
      ...
      _updateCache: function (t) {
        this.options;
        (this.offset = this.helper.offset()),
          p(t.left) && (this.position.left = t.left),
          p(t.top) && (this.position.top = t.top),
          p(t.height) && (this.size.height = t.height),
          p(t.width) && (this.size.width = t.width);
      },
      _updateRatio: function (t, e) {
        ...
        return (
          p(t.height)
            ...
            : p(t.width) && (t.height = t.width / this.aspectRatio),
          "sw" == n &&
            ((t.left = i.left + (s.width - t.width)), (t.top = null)),
          "nw" == n &&
            ((t.top = i.top + (s.height - t.height)),
            (t.left = i.left + (s.width - t.width))),
          t
        );
      },
      _respectSize: function (t, e) {
        ...
        r && (t.width = i.minWidth),
          a && (t.height = i.minHeight),
          n && (t.width = i.maxWidth),
          o && (t.height = i.maxHeight);
        var l = this.originalPosition.left + this.originalSize.width,
          h = this.position.top + this.size.height,
          c = /sw|nw|w/.test(s),
          u = /nw|ne|n/.test(s);
        r && c && (t.left = l - i.minWidth),
          n && c && (t.left = l - i.maxWidth),
          a && u && (t.top = h - i.minHeight),
          o && u && (t.top = h - i.maxHeight);
        var d = !t.width && !t.height;
        return (
          d && !t.left && t.top
            ? (t.top = null)
            : d && !t.top && t.left && (t.left = null),
          t
        );
      },
      _proportionallyResize: function () {
        ...
        if (this._proportionallyResizeElements.length)
          for (
            var t = this.helper || this.element, e = 0;
            ...
            (f.browser.msie &&
              (f(t).is(":hidden") || f(t).parents(":hidden").length)) ||
              i.css({
      ...
      _renderProxy: function () {
        ...
        if (((this.elementOffset = t.offset()), this._helper)) {
          this.helper =
            this.helper || f('<div style="overflow:hidden;"></div>');
      ...
      _propagate: function (t, e) {
        f.ui.plugin.call(this, t, [e, this.ui()]),
        ...
        stop: function (e, t) {
          ...
          i.element.animate(f.extend(l, c && h ? { top: c, left: h } : {}), {
            ...
            step: function () {
              ...
              n &&
                n.length &&
                f(n[0]).css({ width: t.width, height: t.height }),
                i._updateCache(t),
      ...
      f.ui.plugin.add("resizable", "containment", {
        start: function (t, e) {
          ...
          if (r)
            if (
              ((i.containerElement = f(r)), /document/.test(o) || o == document)
            )
        ...
        resize: function (t, e) {
          ...
          u && d && (h -= i.parentData.left),
            h + i.size.width >= i.parentData.width &&
              ...
              r && (i.size.height = i.size.width / i.aspectRatio)),
            c + i.size.height >= i.parentData.height &&
              ((i.size.height = i.parentData.height - c),
              r && (i.size.width = i.size.height * i.aspectRatio));
        },
        stop: function (t, e) {
          var i = f(this).data("resizable"),
      ...
      f.ui.plugin.add("resizable", "grid", {
        resize: function (t, e) {
          ...
          var l =
              Math.round((n.width - o.width) / (s.grid[0] || 1)) *
              (s.grid[0] || 1),
            h =
              Math.round((n.height - o.height) / (s.grid[1] || 1)) *
              (s.grid[1] || 1);
          /^(se|s|e)$/.test(a)
            ? ((i.size.width = o.width + l), (i.size.height = o.height + h))
            : /^(ne)$/.test(a)
            ? ((i.size.width = o.width + l),
              (i.size.height = o.height + h),
              (i.position.top = r.top - h))
            : (/^(sw)$/.test(a)
                ? ((i.size.width = o.width + l), (i.size.height = o.height + h))
                : ((i.size.width = o.width + l),
                  (i.size.height = o.height + h),
                  (i.position.top = r.top - h)),
              (i.position.left = r.left - l));
        },
      });
    var g = function (t) {
            ...
            this.selectees.each(function () {
              ...
              if (t && t.element != s.element[0]) {
                ...
                "touch" == n.tolerance
                  ...
                  : "fit" == n.tolerance &&
                    (e =
                      t.left > o && t.right < a && t.top > r && t.bottom < l),
                  e
                    ? (t.selected &&
                        (t.$element.removeClass("ui-selected"),
                        (t.selected = !1)),
    ...
    d.widget("ui.sortable", d.ui.mouse, {
      ...
      _mouseCapture: function (t, e) {
        ...
        d(t.target)
          .parents()
          .each(function () {
            if (d.data(this, i.widgetName + "-item") == n)
              return (s = d(this)), !1;
          });
        if (
          (d.data(t.target, i.widgetName + "-item") == n && (s = d(t.target)),
          !s)
        )
          return !1;
      ...
      _mouseStart: function (t, e, i) {
        ...
        if (
          ...
          for (var n = this.containers.length - 1; 0 <= n; n--)
        ...
        if (
          ...
          "HTML" != this.scrollParent[0].tagName
            ...
            : (t.pageY - d(document).scrollTop() < e.scrollSensitivity
                ? (i = d(document).scrollTop(
                    d(document).scrollTop() - e.scrollSpeed
                  ))
                : d(window).height() - (t.pageY - d(document).scrollTop()) <
                    e.scrollSensitivity &&
                  (i = d(document).scrollTop(
                    d(document).scrollTop() + e.scrollSpeed
                  )),
              t.pageX - d(document).scrollLeft() < e.scrollSensitivity
                ? (i = d(document).scrollLeft(
                    d(document).scrollLeft() - e.scrollSpeed
                  ))
                : d(window).width() - (t.pageX - d(document).scrollLeft()) <
                    e.scrollSensitivity &&
                  (i = d(document).scrollLeft(
                    d(document).scrollLeft() + e.scrollSpeed
                  ))),
        ...
        for (var s = this.items.length - 1; 0 <= s; s--) {
          ...
          if (
            ...
            !(
              ...
              d.ui.contains(this.placeholder[0], o) ||
              ("semi-dynamic" == this.options.type &&
                d.ui.contains(this.element[0], o))
            )
          ) {
            if (
      ...
      _refreshItems: function (t) {
        ...
        for (n = i.length - 1; 0 <= n; n--)
          for (
            var l = i[n][1], h = i[n][0], c = ((r = 0), h.length);
            r < c;
            r++
          ) {
            var u = d(h[r]);
            u.data(this.widgetName + "-item", l),
              e.push({
                item: u,
                instance: l,
                width: 0,
      ...
      _contactContainers: function (t) {
        for (
          var e = null, i = null, s = this.containers.length - 1;
          0 <= s;
          s--
        )
          if (
            !d.ui.contains(this.currentItem[0], this.containers[s].element[0])
          )
            if (this._intersectsWith(this.containers[s].containerCache)) {
              if (
                e &&
                d.ui.contains(this.containers[s].element[0], e.element[0])
              )
                continue;
          ...
          if (1 === this.containers.length)
            ...
            for (
              ...
              if (
                ...
                var l = this.containers[i].floating
                  ? this.items[a].item.offset().left
                  : this.items[a].item.offset().top;
                Math.abs(l - r) < n &&
                  ((n = Math.abs(l - r)),
                  (o = this.items[a]),
                  (this.direction = 0 < l - r ? "down" : "up"));
              }
        ...
        if (
          ...
          ("document" != t.containment && "window" != t.containment) ||
            (this.containment = [
              ...
              d("document" == t.containment ? document : window).width() -
                this.helperProportions.width -
                this.margins.left,
              (d("document" == t.containment ? document : window).height() ||
                document.body.parentNode.scrollHeight) -
                this.helperProportions.height -
                this.margins.top,
            ]),
          ...
          this.containment = [
            i.left +
              ...
              (parseInt(d(e).css("paddingLeft"), 10) || 0) -
              this.margins.left,
            i.top +
              (parseInt(d(e).css("borderTopWidth"), 10) || 0) +
              (parseInt(d(e).css("paddingTop"), 10) || 0) -
              this.margins.top,
            i.left +
      ...
      _convertPositionTo: function (t, e) {
        ...
        return {
          top:
            ...
            this.offset.relative.top * i +
            this.offset.parent.top * i -
            (d.browser.safari && "fixed" == this.cssPosition
              ? 0
              : ("fixed" == this.cssPosition
                  ? -this.scrollParent.scrollTop()
                  : n
  ...
  jQuery.effects ||
    (function (h, r) {
      ...
      function u(t) {
        ...
        for (e in t)
          (null == (i = t[e]) ||
            ...
            e in o ||
            /scrollbar/.test(e) ||
            (!/color/i.test(e) && isNaN(parseFloat(i)))) &&
            delete t[e];
        return t;
      }
      function l(t, e, i, s) {
      ...
      function i(t) {
        return (
          !(t && "number" != typeof t && !h.fx.speeds[t]) ||
          ("string" == typeof t && !h.effects[t])
        );
      }
      (h.effects = {}),
        h.each(
      ...
      (h.effects.animateClass = function (o, r, a, l) {
                ...
                })(s, t),
                {
                  ...
                  complete: function () {
                    h.each(d, function (t, e) {
                      ...
                      "object" == typeof i.attr("style")
                        ? ((i.attr("style").cssText = ""),
                          (i.attr("style").cssText = e))
                        : i.attr("style", e),
        ...
        h.fn.extend({
          ...
          addClass: function (t, e, i, s) {
            return e
              ? h.effects.animateClass.apply(this, [{ add: t }, e, i, s])
              : this._addClass(t);
          },
          _removeClass: h.fn.removeClass,
          removeClass: function (t, e, i, s) {
            return e
              ? h.effects.animateClass.apply(this, [{ remove: t }, e, i, s])
              : this._removeClass(t);
          },
          _toggleClass: h.fn.toggleClass,
          toggleClass: function (t, e, i, s, n) {
            return "boolean" == typeof e || e === r
              ? i
                ? h.effects.animateClass.apply(this, [
                    e ? { add: t } : { remove: t },
                    i,
                    s,
                    n,
              ...
              : h.effects.animateClass.apply(this, [{ toggle: t }, e, i, s]);
          },
        ...
        h.extend(h.effects, {
          ...
          removeWrapper: function (t) {
            ...
            return t.parent().is(".ui-effects-wrapper")
              ? ((e = t.parent().replaceWith(t)),
                (t[0] === i || h.contains(t[0], i)) && h(i).focus(),
                e)
              : t;
          },
        ...
        h.fn.extend({
          ...
          toggle: function (t) {
            if (i(t) || "boolean" == typeof t || h.isFunction(t))
        ...
        h.extend(h.easing, {
          ...
          easeInBack: function (t, e, i, s, n, o) {
            return (
              o == r && (o = 1.70158), s * (e /= n) * e * ((o + 1) * e - o) + i
            );
          },
          ...
          easeInOutBack: function (t, e, i, s, n, o) {
            return (
              o == r && (o = 1.70158),
              (e /= n / 2) < 1
                ? (s / 2) * e * e * ((1 + (o *= 1.525)) * e - o) + i
                : (s / 2) * ((e -= 2) * e * ((1 + (o *= 1.525)) * e + o) + 2) +
                  i
            );
          },
          ...
          easeInOutBounce: function (t, e, i, s, n) {
            return e < n / 2
              ? 0.5 * h.easing.easeInBounce(t, 2 * e, 0, s, n) + i
              : 0.5 * h.easing.easeOutBounce(t, 2 * e - n, 0, s, n) +
                  0.5 * s +
                  i;
          },
        });
      ...
      return this.queue(function () {
        ...
        (a[o] = "show" == i ? r : 0),
          n.animate(a, l.duration, l.options.easing, function () {
            "hide" == i && t.hide(),
              h.effects.restore(t, e),
              h.effects.removeWrapper(t),
              l.callback && l.callback.apply(t[0], arguments),
              t.dequeue();
          });
      });
    };
    ...
    f.effects.bounce = function (p) {
      return this.queue(function () {
        var t = f(this),
          ...
          o = p.options.times || 5,
          r = p.duration || 250;
        /show|hide/.test(i) && e.push("opacity"),
          f.effects.save(t, e),
          t.show(),
          f.effects.createWrapper(t);
        var a = "up" == s || "down" == s ? "top" : "left",
          l = "up" == s || "left" == s ? "pos" : "neg";
        n =
          p.options.distance ||
          ("top" == a ? t.outerHeight(!0) / 3 : t.outerWidth(!0) / 3);
        ("show" == i && t.css("opacity", 0).css(a, "pos" == l ? -n : n),
        "hide" == i && (n /= 2 * o),
        "hide" != i && o--,
        "show" == i) &&
          (((u = { opacity: 1 })[a] = ("pos" == l ? "+=" : "-=") + n),
          t.animate(u, r / 2, p.options.easing),
          (n /= 2),
          o--);
        for (var h = 0; h < o; h++) {
          var c = {};
          ((d = {})[a] = ("pos" == l ? "-=" : "+=") + n),
            (c[a] = ("pos" == l ? "+=" : "-=") + n),
            t
              .animate(d, r / 2, p.options.easing)
              .animate(c, r / 2, p.options.easing),
            (n = "hide" == i ? 2 * n : n / 2);
        }
        if ("hide" == i) {
          var u;
          ((u = { opacity: 0 })[a] = ("pos" == l ? "-=" : "+=") + n),
            t.animate(u, r / 2, p.options.easing, function () {
              t.hide(),
                f.effects.restore(t, e),
                f.effects.removeWrapper(t),
                p.callback && p.callback.apply(this, arguments);
            });
        } else {
          var d;
          c = {};
          ((d = {})[a] = ("pos" == l ? "-=" : "+=") + n),
            ...
            t
              .animate(d, r / 2, p.options.easing)
              .animate(c, r / 2, p.options.easing, function () {
                f.effects.restore(t, e),
                  f.effects.removeWrapper(t),
                  p.callback && p.callback.apply(this, arguments);
              });
      ...
      return this.queue(function () {
        ...
        (l[r.size] = "show" == i ? a : 0),
          ...
          o.animate(l, {
            ...
            complete: function () {
              "hide" == i && t.hide(),
                c.effects.restore(t, e),
                c.effects.removeWrapper(t),
                h.callback && h.callback.apply(t[0], arguments),
                t.dequeue();
            },
          });
      });
    ...
    h.effects.drop = function (l) {
      return this.queue(function () {
        ...
        var n = "up" == s || "down" == s ? "top" : "left",
          ...
          r =
            l.options.distance ||
            ("top" == n ? t.outerHeight(!0) / 2 : t.outerWidth(!0) / 2);
          ...
          t.animate(a, {
            ...
            complete: function () {
              "hide" == i && t.hide(),
                h.effects.restore(t, e),
                h.effects.removeWrapper(t),
                l.callback && l.callback.apply(this, arguments),
                t.dequeue();
            },
          });
      });
      ...
      return this.queue(function () {
            ...
            i.clone()
              ...
              .css({
                ...
                left:
                  ...
                  a * (n / e) +
                  ("show" == l.options.mode
                    ? (a - Math.floor(e / 2)) * (n / e)
                    : 0),
                top:
                  s.top +
                  r * (o / t) +
                  ("show" == l.options.mode
                    ? (r - Math.floor(t / 2)) * (o / t)
                    : 0),
        ...
        setTimeout(function () {
          "show" == l.options.mode
            ...
            l.callback && l.callback.apply(i[0]),
            i.dequeue(),
    ...
    f.effects.fold = function (p) {
      return this.queue(function () {
        ...
        var r = f.effects.createWrapper(t).css({ overflow: "hidden" }),
          ...
          c = /([0-9]+)%/.exec(s);
        c && (s = (parseInt(c[1], 10) / 100) * h["hide" == i ? 0 : 1]),
          "show" == i &&
            r.css(n ? { height: 0, width: s } : { height: s, width: 0 });
        var u = {},
          d = {};
        (u[l[0]] = "show" == i ? h[0] : s),
          (d[l[1]] = "show" == i ? h[1] : 0),
          r
            .animate(u, o, p.options.easing)
            .animate(d, o, p.options.easing, function () {
              "hide" == i && t.hide(),
                f.effects.restore(t, e),
                f.effects.removeWrapper(t),
                p.callback && p.callback.apply(t[0], arguments),
                t.dequeue();
            });
      });
    };
        ...
        "hide" == i && (s.opacity = 0),
          ...
          t
            ...
            .animate(s, {
              ...
              complete: function () {
                "hide" == i && t.hide(),
                  o.effects.restore(t, e),
                  "show" == i &&
                    !o.support.opacity &&
                    this.style.removeAttribute("filter"),
                  n.callback && n.callback.apply(this, arguments),
                  t.dequeue();
              },
            });
      });
    ...
    l.effects.pulsate = function (a) {
      return this.queue(function () {
        var t = l(this),
          ...
          n = t.is(":visible"),
          o = 0;
        n || (t.css("opacity", 0).show(), (o = 1)),
          (("hide" == e && n) || ("show" == e && !n)) && i--;
        for (var r = 0; r < i; r++)
          t.animate({ opacity: o }, s, a.options.easing), (o = (o + 1) % 2);
    ...
    (g.effects.puff = function (o) {
      return this.queue(function () {
        ...
        g.extend(o.options, {
          ...
          t.effect("scale", o.options, o.duration, o.callback),
          t.dequeue();
      });
    }),
      (g.effects.scale = function (h) {
        return this.queue(function () {
          var t = g(this),
            ...
            s =
              parseInt(h.options.percent, 10) ||
              (0 == parseInt(h.options.percent, 10)
                ? 0
                : "hide" == i
                ? 0
                : 100),
            ...
            o = h.options.origin;
          "effect" != i &&
            ((e.origin = o || ["middle", "center"]), (e.restore = !0));
          var r = { height: t.height(), width: t.width() };
          t.from =
            h.options.from || ("show" == i ? { height: 0, width: 0 } : r);
          var a = "horizontal" != n ? s / 100 : 1,
            l = "vertical" != n ? s / 100 : 1;
          (t.to = { height: r.height * a, width: r.width * l }),
            h.options.fade &&
              ("show" == i && ((t.from.opacity = 0), (t.to.opacity = 1)),
              "hide" == i && ((t.from.opacity = 1), (t.to.opacity = 0))),
            (e.from = t.from),
            (e.to = t.to),
            (e.mode = i),
      ...
      (g.effects.size = function (f) {
        return this.queue(function () {
          ...
          if (((t.from = f.options.from || u), (t.to = f.options.to || u), c)) {
            ...
            (t.from.top = (u.height - t.from.height) * d.y),
              (t.from.left = (u.width - t.from.width) * d.x),
              (t.to.top = (u.height - t.to.height) * d.y),
              (t.to.left = (u.width - t.to.width) * d.x);
          }
          var p = {
          ...
          ("box" != h && "both" != h) ||
            (p.from.y != p.to.y &&
              ((e = e.concat(o)),
              (t.from = g.effects.setTransition(t, o, p.from.y, t.from)),
              (t.to = g.effects.setTransition(t, o, p.to.y, t.to))),
            p.from.x != p.to.x &&
              ((e = e.concat(r)),
              (t.from = g.effects.setTransition(t, r, p.from.x, t.from)),
              (t.to = g.effects.setTransition(t, r, p.to.x, t.to)))),
            ("content" == h || "both" == h) &&
              p.from.y != p.to.y &&
              ((e = e.concat(n)),
              (t.from = g.effects.setTransition(t, n, p.from.y, t.from)),
              (t.to = g.effects.setTransition(t, n, p.to.y, t.to))),
            ...
            t.animate(t.to, {
              ...
              complete: function () {
                0 === t.to.opacity && t.css("opacity", t.from.opacity),
                  "hide" == a && t.hide(),
                  g.effects.restore(t, l ? e : i),
                  g.effects.removeWrapper(t),
    ...
    p.effects.shake = function (d) {
      return this.queue(function () {
        var t = p(this),
          e = ["position", "top", "bottom", "left", "right"],
          i =
            (p.effects.setMode(t, d.options.mode || "effect"),
            d.options.direction || "left"),
        ...
        (l[r] = ("pos" == a ? "-=" : "+=") + s),
          (h[r] = ("pos" == a ? "+=" : "-=") + 2 * s),
          (c[r] = ("pos" == a ? "-=" : "+=") + 2 * s),
          t.animate(l, o, d.options.easing);
        for (var u = 1; u < n; u++)
          t.animate(h, o, d.options.easing).animate(c, o, d.options.easing);
        t
          .animate(h, o, d.options.easing)
          .animate(l, o / 2, d.options.easing, function () {
            p.effects.restore(t, e),
              p.effects.removeWrapper(t),
  ...
  (function (h, t) {
    h.effects.slide = function (l) {
      return this.queue(function () {
        ...
        h.effects.save(t, e),
          t.show(),
          h.effects.createWrapper(t).css({ overflow: "hidden" });
        var n = "up" == s || "down" == s ? "top" : "left",
          o = "up" == s || "left" == s ? "pos" : "neg",
          r =
            l.options.distance ||
            ("top" == n ? t.outerHeight(!0) : t.outerWidth(!0));
        ...
        var t = a(this),
          ...
          o = a('<div class="ui-effects-transfer"></div>')
            ...
            .animate(s, r.duration, r.options.easing, function () {
              o.remove(),
                r.callback && r.callback.apply(t[0], arguments),
                t.dequeue();
            });
      });
    };
  ...
  (function (d, t) {
    d.widget("ui.accordion", {
      ...
      _create: function () {
        ...
        if (
          ...
          if (i.length) {
            ...
            s.length
              ? (e.active = s)
              : (e.active = i.closest(".ui-accordion-content").prev());
          }
        }
        (e.active = e
          ...
          t.event &&
            e.headers.bind(
              t.event.split(" ").join(".accordion ") + ".accordion",
              function (t) {
      ...
      destroy: function () {
        ...
        return (
          (t.autoHeight || t.fillHeight) && e.css("height", ""),
          d.Widget.prototype.destroy.call(this)
        );
      },
      _setOption: function (t, e) {
        ...
        if (e.fillSpace) {
          ...
          (t = this.element.parent().height()),
            ...
            this.headers
              ...
              .each(function () {
                d(this).height(
                  Math.max(0, t - d(this).innerHeight() + d(this).height())
                );
              })
              .css("overflow", "auto");
        } else
        ...
        if (!i.disabled)
          if (t.target) {
            var s = d(t.currentTarget || e),
              n = s[0] === this.active[0];
            if (
              ((i.active = (!i.collapsible || !n) && this.headers.index(s)),
              !(this.running || (!i.collapsible && n)))
            ) {
              var o = this.active,
                r =
                  ((h = s.next()),
              ...
              (this.active = n ? d([]) : s),
                ...
                o
                  ...
                  .children(".ui-icon")
                  .removeClass(i.icons.headerSelected)
                ...
                n ||
                  (s
                    ...
                    .addClass(i.icons.headerSelected),
      ...
      _toggle: function (t, e, i, s, n) {
        ...
        if (
          ...
          (l =
            ...
            (r.duration = d.isFunction(r.proxiedDuration)
              ? r.proxiedDuration(l)
              : r.proxiedDuration);
                ...
                (e = a[0].style.width),
                  a.width(
                    a.parent().width() -
                      ...
                      (parseFloat(a.css("borderLeftWidth")) || 0) -
                      (parseFloat(a.css("borderRightWidth")) || 0)
                  ),
                  d.each(
                    ["height", "paddingTop", "paddingBottom"],
                    function (t, e) {
                      r[e] = "hide";
                      var i = ("" + d.css(s.toShow[0], e)).match(
                        /^([\d+-.]+)(.*)$/
                      );
                      ...
                      step: function (t, e) {
                        "height" == e.prop &&
                          (n =
                            e.end - e.start == 0
                              ? 0
                              : (e.now - e.start) / (e.end - e.start)),
                          (s.toShow[0].style[e.prop] =
                            n * o[e.prop].value + o[e.prop].unit);
                      },
                      duration: s.duration,
                      easing: s.easing,
                      complete: function () {
                        s.autoHeight || s.toShow.css("height", ""),
                          s.toShow.css({ width: e, overflow: i }),
                          s.complete();
                      },
                    });
              } else
        ...
        (this.isMultiLine = this.element.is("textarea")),
          this.element
                    ...
                    clearTimeout(n.searching),
                      (n.searching = setTimeout(function () {
                        n.term != n.element.val() &&
                          ((n.selectedItem = null), n.search(null, t));
                      }, n.options.delay));
                }
              }
            })
            ...
            .bind("focus.autocomplete", function () {
              n.options.disabled ||
                ((n.selectedItem = null), (n.previous = n.element.val()));
            })
          ...
          (this.menu = r("<ul></ul>")
              ...
              r(t.target).closest(".ui-menu-item").length ||
                setTimeout(function () {
                  r(document).one("mousedown", function (t) {
                    t.target !== n.element[0] &&
                      t.target !== e &&
                      !r.ui.contains(e, t.target) &&
                      n.close();
                  });
                }, 1),
                setTimeout(function () {
            ...
            .menu({
              focus: function (t, e) {
                ...
                !1 !== n._trigger("focus", t, { item: i }) &&
                  /^key/.test(t.originalEvent.type) &&
                  n.element.val(i.value);
              },
        ...
        r.Widget.prototype._setOption.apply(this, arguments),
          ...
          "appendTo" === t &&
            this.menu.element.appendTo(
              r(e || "body", this.element[0].ownerDocument)[0]
            ),
    ...
    n.widget("ui.menu", {
      _create: function () {
        ...
        this.element
          ...
          .click(function (t) {
            n(t.target).closest(".ui-menu-item a").length &&
      ...
      activate: function (t, e) {
        if ((this.deactivate(), this.hasScroll())) {
          ...
          i < 0
            ...
            : n <= i && this.element.scrollTop(s + i - n + e.height());
        }
        (this.active = e
          .eq(0)
          .children("a")
      ...
      previousPage: function (t) {
        if (this.hasScroll()) {
          ...
          s.length || (s = this.element.children(".ui-menu-item:first")),
            this.activate(t, s);
        } else
          this.activate(
            t,
          ...
          this.buttonElement
            ...
            .bind("mouseenter.button", function () {
              i.disabled ||
                ...
                this === r && o(this).addClass("ui-state-active"));
            })
      ...
      _resetButton: function () {
        if ("input" !== this.type) {
          var t = this.buttonElement.removeClass(u),
            e = o("<span></span>", this.element[0].ownerDocument)
  ...
  (function ($, undefined) {
      ...
      return i
        ...
        .bind("mouseover", function (t) {
          ...
          !$.datepicker._isDisabledDatepicker(
            instActive.inline ? i.parent()[0] : instActive.input[0]
          ) &&
            e.length &&
            (e
            ...
            e.hasClass("ui-datepicker-prev") &&
              e.addClass("ui-datepicker-prev-hover"),
            e.hasClass("ui-datepicker-next") &&
              e.addClass("ui-datepicker-next-hover"));
        });
    }
    ...
    $.extend(Datepicker.prototype, {
          ...
          (e.trigger = $(
            this._get(e, "buttonImageOnly")
              ...
              : $('<button type="button"></button>')
                  .addClass(this._triggerClass)
                  .html(
                    "" == r ? o : $("<img/>").attr({ src: r, alt: o, title: o })
                  )
          )),
      ...
      _dialogDatepicker: function (t, e, i, s, n) {
        ...
        if (
          (extendRemove(o.settings, s || {}),
          (e = e && e.constructor == Date ? this._formatDate(o, e) : e),
        ...
        if (("string" == typeof e && ((n = {})[e] = i), s)) {
          ...
          extendRemove(s.settings, n),
            null !== r &&
              ...
              n.minDate === undefined &&
              (s.settings.minDate = this._formatDate(s, r)),
            null !== a &&
              n.dateFormat !== undefined &&
              n.maxDate === undefined &&
          ...
          if (!1 !== s) {
            ...
            if (
              ...
              i.dpDiv.zIndex($(t).zIndex() + 1),
                ...
                $.effects && $.effects[r]
                  ? i.dpDiv.show(r, $.datepicker._get(i, "showOptions"), a, l)
                  : i.dpDiv[r || "show"](r ? a : null, l),
                (!r || !a) && l(),
                i.input.is(":visible") &&
                  !i.input.is(":disabled") &&
                  i.input.focus(),
      ...
      _updateDatepicker: function (t) {
        ...
        (instActive = t).dpDiv.empty().append(this._generateHTML(t)),
      ...
      _hideDatepicker: function (t) {
        ...
        if (e && (!t || e == $.data(t, PROP_NAME)) && this._datepickerShowing) {
          ...
          o &&
            o.apply(e.input ? e.input[0] : null, [
              e.input ? e.input.val() : "",
              e,
            ]),
      ...
      _selectDay: function (t, e, i, s) {
        ...
        if (
          ...
          (o.selectedDay = o.currentDay = $("a", s).html()),
      ...
      parseDate: function (i, o, t) {
          ...
          var s = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort,
            ...
            g = function (t, e, i) {
              ...
              if (
                ($.each(s, function (t, e) {
                  var i = e[1];
                  if (o.substr(v, i.length).toLowerCase() == i.toLowerCase())
                    return (n = e[0]), (v += i.length), !1;
                }),
                -1 != n)
              )
                return n + 1;
        ...
        if (v < o.length)
          throw "Extra/unparsed characters found in date: " + o.substring(v);
        if (
          (-1 == l
              ...
              ? (function (t) {
                  ...
                  for (
                    ...
                    switch (r[2] || "d") {
                      ...
                      case "M":
                        (s += parseInt(r[1], 10)),
                          (n = Math.min(n, $.datepicker._getDaysInMonth(i, s)));
                        break;
                      case "y":
                      case "Y":
                        (i += parseInt(r[1], 10)),
      ...
      _generateHTML: function (t) {
        ...
        for (
          ...
          for (var H = 0; H < r[1]; H++) {
            ...
            this.maxRows = Q;
            for (
              var V = this._daylightSavingAdjust(new Date(f, p, 1 - K)), X = 0;
              X < Q;
              X++
            ) {
              R += "<tr>";
              ...
              for (q = 0; q < 7; q++) {
                var G = A
                    ? A.apply(t.input ? t.input[0] : null, [V])
                    : [!0, ""],
                  J = V.getMonth() != p,
                ...
                (Z +=
                  ...
                  ((V.getTime() == W.getTime() &&
                    p == t.selectedMonth &&
                    t._keyEvent) ||
                  (M.getTime() == V.getTime() && M.getTime() == W.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (tt
      ...
      _generateMonthYearHeader: function (t, e, i, s, n, o, r, a) {
        var l = this._get(t, "changeMonth"),
          ...
          d = "";
        if (o || !l)
          d += '<span class="ui-datepicker-month">' + r[e] + "</span>";
        else {
    ...
    a.widget("ui.dialog", {
      ...
      _makeDraggable: function () {
        ...
        n.uiDialog.draggable({
          ...
          start: function (t, e) {
            (s = "auto" === o.height ? "auto" : a(this).height()),
          ...
          stop: function (t, e) {
            (o.position = [
              e.position.left - r.scrollLeft(),
              e.position.top - r.scrollTop(),
            ]),
              a(this).removeClass("ui-dialog-dragging").height(s),
      ...
      _position: function (t) {
        ...
        t
          ? (("string" == typeof t || ("object" == typeof t && "0" in t)) &&
              (1 === (i = t.split ? t.split(" ") : [t[0], t[1]]).length &&
                (i[1] = i[0]),
      ...
      _setOption: function (t, e) {
        ...
        switch (t) {
          ...
          case "disabled":
            e
              ? s.addClass("ui-dialog-disabled")
              : s.removeClass("ui-dialog-disabled");
            break;
          case "draggable":
          ...
          case "resizable":
            ...
            o && !e && s.resizable("destroy"),
              o && "string" == typeof e && s.resizable("option", "handles", e),
              !o && !1 !== e && i._makeResizable(e);
            break;
          case "title":
            a(".ui-dialog-title", i.uiDialogTitlebar).html(
              "" + (e || "&#160;")
            );
        }
            ...
            (setTimeout(function () {
              a.ui.dialog.overlay.instances.length &&
                a(document).bind(a.ui.dialog.overlay.events, function (t) {
                  if (a(t.target).zIndex() < a.ui.dialog.overlay.maxZ)
                    return !1;
                });
            }, 1),
    ...
    (g.fn.position = function (h) {
      ...
      return (
        9 === e.nodeType
          ...
          ? ((c = t.width()),
            (u = t.height()),
            (d = { top: t.scrollTop(), left: t.scrollLeft() }))
          : e.preventDefault
          ? ((h.at = "left top"),
            (c = u = 0),
            (d = { top: h.of.pageY, left: h.of.pageX }))
        ...
        g.each(["my", "at"], function () {
          ...
          1 === t.length &&
            (t = i.test(t[0])
              ...
              ? [m].concat(t)
              : [m, m]),
            (t[0] = i.test(t[0]) ? t[0] : m),
            (t[1] = s.test(t[1]) ? t[1] : m),
            (h[this] = t);
        }),
        1 === p.length && (p[1] = p[0]),
        ...
        this.each(function () {
          ...
          "right" === h.my[0]
            ...
            "bottom" === h.my[1]
              ...
              : h.my[1] === m && (l.top -= n / 2),
            v.fractions ||
              ((l.left = Math.round(l.left)), (l.top = Math.round(l.top))),
            (i = { left: l.left - e, top: l.top - o }),
            g.each(["left", "top"], function (t, e) {
              g.ui.position[p[t]] &&
                g.ui.position[p[t]][e](l, {
                  targetWidth: c,
                  targetHeight: u,
                  elemWidth: s,
                  elemHeight: n,
        ...
        fit: {
          left: function (t, e) {
            ...
            t.left =
              0 < s
                ? t.left - s
                : Math.max(t.left - e.collisionPosition.left, t.left);
          },
          top: function (t, e) {
            var i = g(window),
              s =
                e.collisionPosition.top +
                e.collisionHeight -
                i.height() -
                i.scrollTop();
            t.top =
              0 < s
                ? t.top - s
                : Math.max(t.top - e.collisionPosition.top, t.top);
          },
        },
        flip: {
          left: function (t, e) {
          ...
          top: function (t, e) {
            if (e.at[1] !== m) {
              var i = g(window),
                ...
                r = -2 * e.offset[1];
              t.top +=
                e.collisionPosition.top < 0 ? n + o + r : 0 < s ? n + o + r : 0;
            }
          },
        },
      }),
      g.offset.setOffset ||
        ((g.offset.setOffset = function (t, e) {
          /static/.test(g.curCSS(t, "position")) &&
    ...
    i.widget("ui.progressbar", {
      ...
      _setOption: function (t, e) {
        "value" === t &&
          ...
          i.Widget.prototype._setOption.apply(this, arguments);
      },
      _value: function () {
        ...
        (this._keySliding = !1),
          ...
          this.element.addClass(
            "ui-slider ui-slider-" +
              ...
              (t.disabled ? " ui-slider-disabled ui-disabled" : "")
          ),
          (this.range = c([])),
          t.range &&
            (!0 === t.range &&
              (t.values || (t.values = [this._valueMin(), this._valueMin()]),
              t.values.length &&
                2 !== t.values.length &&
        ...
        (this.handles = e.add(c(s.join("")).appendTo(o.element))),
          ...
          this.handles
            ...
            .focus(function () {
              t.disabled
                ? c(this).blur()
                : (c(".ui-slider .ui-state-focus").removeClass(
                    "ui-state-focus"
                  ),
  ...
  (function (p, t) {
    ...
    p.widget("ui.tabs", {
      ...
      _cookie: function () {
        var t =
          this.cookie ||
          (this.cookie = this.options.cookie.name || "ui-tabs-" + ++i);
      ...
      _tabify: function (t) {
        ...
        (this.list = this.element.find("ol,ul").eq(0)),
          ...
          this.anchors.each(function (t, e) {
            ...
            if (
              (n &&
                (n === location.toString().split("#")[0] ||
                  ((i = p("base")[0]) && n === i.href)) &&
                ((s = e.hash), (e.href = s)),
              h.test(s))
            )
              a.panels = a.panels.add(a.element.find(a._sanitizeSelector(s)));
            else if (s && "#" !== s) {
              p.data(e, "href.tabs", s),
                p.data(e, "load.tabs", s.replace(/#.*$/, ""));
              var o = a._tabId(e);
              e.href = "#" + o;
              ...
              r.length ||
                (r = p(l.panelTemplate)
                  ...
                  .insertAfter(a.panels[t - 1] || a.list)).data(
                  "destroy.tabs",
                  !0
                ),
          ...
          t
            ? (this.element.addClass(
              ...
              void 0 === l.selected
                ? (location.hash &&
                  ...
                  "number" != typeof l.selected &&
                    l.cookie &&
                    (l.selected = parseInt(a._cookie(), 10)),
                  "number" != typeof l.selected &&
              ...
              (l.selected =
                (0 <= l.selected && this.anchors[l.selected]) || l.selected < 0
                  ? l.selected
                  : 0),
              (l.disabled = p
                .unique(
                ...
                .sort()),
              -1 != p.inArray(l.selected, l.disabled) &&
                l.disabled.splice(p.inArray(l.selected, l.disabled), 1),
              this.panels.addClass("ui-tabs-hide"),
              this.lis.removeClass("ui-tabs-selected ui-state-active"),
              0 <= l.selected &&
                this.anchors.length &&
                (a.element
                  .find(a._sanitizeSelector(a.anchors[l.selected].hash))
                ...
                a.element.queue("tabs", function () {
                  a._trigger(
                    ...
                    null,
                    a._ui(
                      a.anchors[l.selected],
                      a.element.find(
                        a._sanitizeSelector(a.anchors[l.selected].hash)
                      )[0]
                    )
                  );
                }),
        ...
        for (var e, o = 0; (e = this.lis[o]); o++)
          p(e)[
            -1 == p.inArray(o, l.disabled) || p(e).hasClass("ui-tabs-selected")
              ? "removeClass"
              : "addClass"
          ]("ui-state-disabled");
        if (
        ...
        l.fx &&
          (p.isArray(l.fx) ? ((s = l.fx[0]), (n = l.fx[1])) : (s = n = l.fx));
        var u = n
            ? function (t, e) {
            ...
            : function (t, e) {
                p(t).closest("li").addClass("ui-tabs-selected ui-state-active"),
                  ...
                  a._trigger("show", null, a._ui(t, e[0]));
              },
          d = s
            ? function (t, e) {
        ...
        this.anchors.bind(l.event + ".tabs", function () {
          ...
          if (
            ...
            return this.blur(), !1;
          if (
            ((l.selected = a.anchors.index(this)), a.abort(), l.collapsible)
          ) {
          ...
          if ((l.cookie && a._cookie(l.selected, l.cookie), !s.length))
      ...
      add: function (t, e, i) {
        ...
        var s = this,
          n = this.options,
          o = p(
            n.tabTemplate.replace(/#\{href\}/g, t).replace(/#\{label\}/g, e)
          ),
        ...
        return (
          a.length ||
            (a = p(n.panelTemplate).attr("id", r).data("destroy.tabs", !0)),
          a.addClass(
            "ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"
          ),
          i >= this.lis.length
            ? (o.appendTo(this.list), a.appendTo(this.list[0].parentNode))
            : (o.insertBefore(this.lis[i]), a.insertBefore(this.panels[i])),
          ...
          return (
            (this.xhr = p.ajax(
              p.extend({}, o.ajaxOptions, {
                url: t,
                success: function (t, e) {
                  n.element.find(n._sanitizeSelector(r.hash)).html(t),
                    n._cleanup(),
                    o.cache && p.data(r, "cache.tabs", !0),
                    n._trigger("load", null, n._ui(n.anchors[s], n.panels[s]));
                  try {
          ...
          return (
            e
              ? (this.element.bind("tabsshow", n),
                this.anchors.bind(s.event + ".tabs", o),
                n())
              : (clearTimeout(i.rotation),
                this.element.unbind("tabsshow", n),
                this.anchors.unbind(s.event + ".tabs", o),
                delete this._rotate,
    ...
    u.each("branch form header step wrapper".split(" "), function () {
      ...
      u.widget("kf." + p, {
        ...
        _create: function () {
          ...
          n[0].elements
            ? (t = n)
            : (t = n.find("form")).length || (t = n.closest("form")),
          ...
          u.isFunction(n) && ((o = n), (n = c)),
            (function i() {
              a._transition(l, function (t, e) {
                if (-1 === (l = a.stepIndex(t, e)))
                  throw new Error('[_fastForward]: Invalid step "' + t + '"');
                if (0 <= u.inArray(l, h))
                  throw new Error(
                    '[_fastForward]: Recursion detected on step "' + t + '"'
                  );
                h.push(l),
                  l === a._lastStepIndex || (n ? ++r : l) === s
                    ? o.call(a, l, h)
                    : i();
              });
            })();
            ...
            for (n = 0, o = (t = d(t)).length; n < o; n++)
              (s = null),
                (a = typeof (r = t[n])) === g
                  ...
                  : "object" === a &&
                    (r instanceof jQuery && r.length && (r = r[0]),
                    r.nodeType && h.each(c)),
                s && l.push(s);
          return !1 === i ? l : u(l);
        },
        _move: function (t, e, i, s, n) {
          ...
          typeof e === m && ((n = s), (s = i), (i = e), (e = c)),
            !0 === i
              ? 0 < t
                ? o._fastForward(t, i, a)
                : n.call(
                    o,
                    r.stepsActivated[
                      Math.max(0, t + (r.stepsActivated.length - 1))
                    ]
                  )
              : -1 !== (t = o.stepIndex(t, e)) &&
                (t > r.stepIndex ? o._fastForward(t, a) : a.call(o, t));
        },
        _state: function (t, e) {
          ...
          for (var s, n, o, r = 0, a = e.length; r < a; r++)
            (t = e[r]),
              ...
              !i.stepIndex || i.stepIndex < t
                ? u.inArray(t, i.stepsActivated) < 0 &&
                  (i.stepsActivated.push(t),
                  u.inArray(s, i.branchesActivated) < 0 &&
                    i.branchesActivated.push(s))
                : i.stepIndex > t &&
                  ((n = u.inArray(s, i.branchesActivated) + 1),
                  (o = u.inArray(t, i.stepsActivated) + 1),
                  0 < n &&
                    i.branchesActivated.splice(
                      n,
                      i.branchesActivated.length - 1
                    ),
                  0 < o &&
                    i.stepsActivated.splice(o, i.stepsActivated.length - 1)),
              (i.stepIndex = t),
              (i.branchLabel = s);
          return (
            (i.stepsComplete = Math.max(
              0,
              this._find(i.stepsActivated, this.elements.steps).filter(
                this._excludesFilter
              ).length - 1
            )),
            (i.stepsPossible = Math.max(
              0,
              this._find(i.branchesActivated, this.elements.branches)
                .children(l.step)
        ...
        _transition: function (t, e, i) {
          var s = this;
          u.isFunction(t)
            ? ((i = t), (t = s._currentState.stepIndex), (e = c))
            : u.isFunction(e) && ((i = e), (e = c));
          var n,
            o = s.options,
            r = s.step(t, e),
        ...
        _update: function (t, e) {
          ...
          if (i.step) {
            if (
              ...
              return;
            i.step
              .removeClass(s.stepClasses.current)
              .animate(
                s.animations.hide.properties,
                u.extend({}, s.animations.hide.options)
              );
          }
          (this._currentState = e).step
            .addClass(s.stepClasses.current)
            .animate(
              s.animations.show.properties,
              u.extend({}, s.animations.show.options)
            ),
            e.isFirstStep ||
            s.unidirectional ||
            e.step.hasClass(s.stepClasses.unidirectional)
              ? this.elements.backward.attr(n, !0)
              : this.elements.backward.removeAttr(n),
            (e.isLastStepInBranch && !e.step.attr(s.stateAttribute)) ||
            e.step.hasClass(s.stepClasses.stop)
              ? this.elements.forward.attr(n, !0)
              : this.elements.forward.removeAttr(n),
            s.enableSubmit || e.step.hasClass(s.stepClasses.submit)
              ? this.elements.submit.removeAttr(n)
              : this.elements.submit.attr(n, !0),
            i.step &&
              (this._trigger("afterSelect", t, e),
              this._trigger(
                e.isMovingForward ? "afterForward" : "afterBackward",
                t,
                e
              ));
        },
        ...
        branches: function (t) {
          return arguments.length
            ? this.branch(t).children(l.branch)
        ...
        state: function (t, e, i) {
          return arguments.length
            ? (u.isArray(t)
                ? ((i = e), (e = t[1]), (t = t[0]))
                : u.isArray(e) && ((i = e), (e = c)),
              this._state(this.stepIndex(t, e), i))
            : this._currentState;
        },
        step: function (t, e) {
          return arguments.length
            ? (u.isArray(t) && ((e = t[1]), (t = t[0])),
              typeof t === g
                ? (i = this._find(
                    t,
                    e !== c ? this.steps(e) : this.elements.steps
                  ))
                : (i = this._find(
                    t,
  ...
  (function (h) {
    h.extend(h.fn, {
            ...
            i.settings.onsubmit &&
              (this.validateDelegate(":submit", "click", function (t) {
                i.settings.submitHandler && (i.submitButton = t.target),
                  h(t.target).hasClass("cancel") && (i.cancelSubmit = !0),
                  void 0 !== h(t.target).attr("formnovalidate") &&
                    (i.cancelSubmit = !0);
              }),
      ...
      rules: function (t, e) {
        ...
        var a = h.validator.normalizeRules(
          h.extend(
            {},
      ...
      h.extend(h.validator, {
        ...
        prototype: {
          ...
          showErrors: function (e) {
            if (e) {
              for (var t in (h.extend(this.errorMap, e),
              (this.errorList = []),
              e))
                this.errorList.push({
                  message: e[t],
            ...
            return h(this.currentForm)
              ...
              .filter(function () {
                return (
                  ...
                  !(this.name in e || !t.objectLength(h(this).rules())) &&
                    (e[this.name] = !0)
                );
              });
          },
          ...
          elementValue: function (t) {
            ...
            return "radio" === e || "checkbox" === e
              ? h("input[name='" + h(t).attr("name") + "']:checked").val()
              : "string" == typeof i
              ? i.replace(/\r/g, "")
              : i;
          },
          check: function (e) {
            ...
            for (var o in i) {
              ...
              try {
                if (
                  "dependency-mismatch" ===
                  (t = h.validator.methods[o].call(this, n, e, r.parameters))
                ) {
                  s = !0;
                  continue;
                }
          ...
          customDataMessage: function (t, e) {
            return (
              h(t).data("msg-" + e.toLowerCase()) ||
              (t.attributes && h(t).attr("data-msg-" + e.toLowerCase()))
            );
          },
              ...
              : ((i = h("<" + this.settings.errorElement + ">")
                ...
                this.labelContainer.append(i).length ||
                  (this.settings.errorPlacement
                    ? this.settings.errorPlacement(i, h(t))
                    : i.insertAfter(t))),
              !e &&
                this.settings.success &&
                (i.text(""),
        ...
        attributeRules: function (t) {
          ...
          for (var n in h.validator.methods) {
            var o;
            "required" === n
              ? ("" === (o = i.get(0).getAttribute(n)) && (o = !0), (o = !!o))
              : (o = i.attr(n)),
              /min|max/.test(n) &&
                  ...
                  !0,
                  {
                    ...
                    success: function (t) {
                      ...
                      if (e) {
                        ...
                        (s[r.name] = a.message = h.isFunction(n) ? n(o) : n),
                          (l.invalid[r.name] = !0),
                          l.showErrors(s);
                      }
  ...
  (function (s) {
    ...
    if (s.ajaxPrefilter)
      ...
      s.ajax = function (t) {
        ...
        return "abort" === e
          ? (n[i] && n[i].abort(), (n[i] = o.apply(this, arguments)), n[i])
      ...
      this.hide(),
        ...
        o(document).on("keydown.nice_select", ".nice-select", function (t) {
          ...
          if (32 == t.keyCode || 13 == t.keyCode)
            return (
              e.hasClass("open") ? i.trigger("click") : e.trigger("click"), !1
            );
          if (40 == t.keyCode) {
            if (e.hasClass("open")) {
              var s = i.nextAll(".option:not(.disabled)").first();
              0 < s.length &&
                (e.find(".focus").removeClass("focus"), s.addClass("focus"));
          ...
          if (38 == t.keyCode) {
            if (e.hasClass("open")) {
              ...
              0 < n.length &&
                (e.find(".focus").removeClass("focus"), n.addClass("focus"));
            } else e.trigger("click");
            return !1;
          }
    ...
    (r.prototype = {
        ...
        if (
          ...
          t.enable &&
            ("toggle" === t.show
              ...
              : "infer" === t.show && (t.show = this.isType("shown", t.states)),
      ...
      updateElement: function () {
        return (
          ...
          (this.element
            .prop(o.extend({}, this.options.props, this.state().props))
      ...
      isType: function (t, e) {
        return (
          (e = e || this.options.states)[
            (t = t || this.state(s, s, e).props.type)
          ] && (t = e[t].props.type),
      ...
      state: function (t, e, i) {
        return (
          ...
          t === s && (t = this.options.show),
          "boolean" == typeof t && (t = t ? "shown" : "hidden"),
          e && (t = "shown" === t ? "hidden" : "shown"),
          i[t]
        );
      },
      ...
      initToggle: function (t) {
        return (
          this.toggleElement.length ||
            ((this.toggleElement = o(t.element)
              .attr(t.attr)
            ...
            t.touchSupport
              ? (this.toggleElement.css(t.touchStyles),
                this.element.on(
                  ...
                  o.proxy(this.toggleTouchEvent, this)
                ))
              : this.toggleElement.on(
                  t.attachToEvent,
                  o.proxy(this.toggleEvent, this)
                ),
            t.attachToKeyCodes.length &&
              this.toggleElement.on(
                t.attachToKeyEvent,
                o.proxy(this.toggleKeyEvent, this)
              )),
          this.toggleElement
        );
      },
      ...
      toggleTouchEvent: function (t) {
        ...
        n &&
          ...
          "left" === this.options.toggle.position
            ? ((i = e), (s = n += this.toggleElement.outerWidth()))
            : ((i = n), (s = e)),
          i <= s && this.toggleEvent(t));
      },
    }),
    ...
    function i(t, e) {
      var i = (function (t) {
          for (
            ...
            (e = s) &&
            (0 === e.offsetWidth || 0 === e.offsetHeight || !1 === e.open);
        ...
        for (var a = 0; a < s; a++)
          (n[a] = i[a].style.cssText),
            i[a].style.setProperty
              ? i[a].style.setProperty("display", "block", "important")
              : (i[a].style.cssText += ";display: block !important"),
            (i[a].style.height = "0"),
    ...
    return (
      ...
      (u.prototype.update = function (t, e) {
        (t = t || !1) &&
          ...
          (this.handleDimension = i(
            this.$handle[0],
            "offset" + n(this.DIMENSION)
          )),
      ...
      (u.prototype.handleDown = function (t) {
        if (
          ...
          var e = this.getRelativePosition(t),
            ...
            n =
              "vertical" === this.orientation
                ? this.maxHandlePos - (e - this.grabPos)
                : e - this.grabPos;
          this.setPosition(n),
            s <= e && e < s + this.handleDimension && (this.grabPos = e - s);
        }
      }),
        ...
        return (
          void 0 !== t.originalEvent["client" + e]
            ...
            : t.originalEvent.touches &&
              ...
              void 0 !== t.originalEvent.touches[0]["client" + e]
            ? (s = t.originalEvent.touches[0]["client" + e])
            : t.currentPoint &&
              void 0 !== t.currentPoint[this.COORDINATE] &&
              (s = t.currentPoint[this.COORDINATE]),
          s - i
        );
      }),
      ...
      (o.fn[r] = function (i) {
        ...
        return this.each(function () {
          var t = o(this),
            e = t.data("plugin_" + r);
          e || t.data("plugin_" + r, (e = new u(this, i))),
            "string" == typeof i && e[i].apply(e, s);
        });
      }),
